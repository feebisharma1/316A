...
function Nav() {
  ...
  return (
    ...
    {/* Hamburger Menu */}
    <div style={{ position: "fixed", top: 0, right: 0, width: menuOpen ? 280 : 0, height: "100vh", background: navy, zIndex: 1100, overflow: "hidden", overflowY: "auto", transition: "width .3s ease", paddingTop: 80, borderLeft: menuOpen ? "2px solid " + gold : "none", boxShadow: menuOpen ? "-10px 0 40px rgba(0,0,0,.3)" : "none" }}>
